...
# Page configuration
st.set_page_config(
    page_title="Deepika Saini - Summer internship Program",
    page_icon="🎓",
    layout="wide",
...
if menu == "🏠 Introduction":
    ...
    st.markdown('<h2 class="section-header">Summer internship Portfolio</h2>', unsafe_allow_html=True)
    ...
    **🎯 Field:** Machine Learning  
    ...
    This comprehensive summer internship program covered multiple cutting-edge technologies and concepts in the field of Machine Learning and DevOps. The internship encompassed practical hands-on experience with Python programming, Linux administration, Docker containerization, Git version control, Kubernetes orchestration, AWS cloud services, and advanced Machine Learning techniques.
...
# Tasks Section
    ...
    python_files = [f for f in os.listdir('.') if f.endswith(('.py', '.ipynb')) and f != 'summer_internship_portfolio.py']
...
# Mini Projects Section
    ...
    **Features:**
    ...
    - Feature engineering
    - Model internship and evaluation
...
# Conclusion Section
    ...
    **Machine Learning:**
    ...
    The skills acquired during this internship will be invaluable for:
    ...
    - **internship Mentors** for their guidance and support throughout the program
